...
STANDARD_SUBCIRCUITS = [
            ...
            "components": [
                {
                    "id": "C1",
                    "type": "capacitor",
                    "parameters": {"capacitance": "100u"},
                    "nodes": ["input", "gnd"],
                },
                {
                    "id": "L1",
                    "type": "inductor",
                    "parameters": {"inductance": "10u"},
                    "nodes": ["input", "output"],
                },
                {
                    "id": "C2",
            ...
            "components": [
                {
                    "id": "L1",
                    "type": "inductor",
                    "parameters": {"inductance": "100n"},
                    "nodes": ["input", "output"],
                },
                {
                    "id": "C1",
                    "type": "capacitor",
                    "parameters": {"capacitance": "100p"},
                    "nodes": ["output", "gnd"],
                },
            ],
        },
    ...
    {
        "name": "multiple_feedback_bandpass",
        "category": "filter",
        ...
        "schema": {
            ...
            "components": [
                ...
                },
                {
                    "id": "R3",
                    "type": "resistor",
                    "parameters": {"resistance": "5k"},
                    "nodes": ["mid2", "gnd"],
                },
                {
                    "id": "C3",
                    "type": "capacitor",
                    "parameters": {"capacitance": "20n"},
                    "nodes": ["mid1", "gnd"],
                },
                {
                    "id": "U1",
        ...
        "schema": {
            ...
            "components": [
                ...
                },
                {
                    "id": "D1",
                    "type": "zener",
                    "parameters": {"breakdown_voltage": "5.1V"},
                    "nodes": ["output", "gnd"],
                },
            ],
        },
    ...
    {
        "name": "instrumentation_amplifier",
        "category": "amplifier",
        ...
        "schema": {
            ...
            "components": [
                ...
                },
                {
                    ...
                    "type": "bjt",
                    "parameters": {"model": "2N2222"},
                    "nodes": ["base_n", "vcc", "output"],
                },
                {
                    "id": "Q2",
                    "type": "bjt",
                    "subtype": "pnp",
                    "parameters": {"model": "2N2907"},
                    "nodes": ["base_n", "vee", "output"],
                },
            ],
        },
            ...
            "components": [
                {
                    "id": "C_in",
                    "type": "capacitor",
                    "parameters": {"capacitance": "330n"},
                    "nodes": ["input", "gnd"],
                },
                {
                    "id": "U1",
                    "type": "voltage_regulator",
                    "parameters": {"output_voltage": "5V"},
                    "nodes": ["input", "output"],
                },
                {
                    "id": "C_out",
            ...
            "components": [
                {
                    "id": "C_in",
                    "type": "capacitor",
                    "parameters": {"capacitance": "1u"},
                    "nodes": ["input", "gnd"],
                },
                {
                    "id": "U1",
                    "type": "voltage_regulator",
                    "parameters": {"output_voltage": "3.3V", "dropout": "0.2V"},
                    "nodes": ["input", "output"],
                },
                {
                    "id": "C_out",
                    "type": "capacitor",
                    "parameters": {"capacitance": "10u"},
                    "nodes": ["output", "gnd"],
                },
            ],
        },
        ...
        "schema": {
            ...
            "components": [
                ...
                },
                {
                    ...
                    "type": "mosfet",
                    "parameters": {},
                    "nodes": ["sw_node", "sw_node", "gnd"],
                },
                {
                    "id": "D1",
                    "type": "diode",
                    "parameters": {},
                    "nodes": ["sw_node", "output"],
                },
                {
                    "id": "C1",
                    "type": "capacitor",
                    "parameters": {"capacitance": "22u"},
                    "nodes": ["output", "gnd"],
                },
            ],
        },
            ...
            "components": [
                {
                    ...
                    "type": "mosfet",
                    "parameters": {},
                    "nodes": ["input", "input", "sw_node"],
                },
                {
                    "id": "L1",
                    "type": "inductor",
                    "parameters": {"inductance": "22u"},
                    "nodes": ["sw_node", "gnd"],
                },
                {
                    "id": "D1",
                    "type": "diode",
                    "parameters": {},
                    "nodes": ["output", "sw_node"],
                },
                {
                    "id": "C1",
                    "type": "capacitor",
                    "parameters": {"capacitance": "47u"},
                    "nodes": ["output", "gnd"],
                },
            ],
        },
        ...
        "schema": {
            ...
            "components": [
                ...
                },
                {
                    ...
                    "type": "mosfet",
                    "parameters": {},
                    "nodes": ["sw_node", "sw_node", "gnd_pri"],
                },
                {
                    "id": "D1",
                    "type": "diode",
                    "parameters": {},
                    "nodes": ["sec_out", "output"],
                },
                {
                    "id": "C1",
                    "type": "capacitor",
                    "parameters": {"capacitance": "47u"},
                    "nodes": ["output", "gnd_sec"],
                },
            ],
        },
        ...
        "schema": {
            ...
            "components": [
                ...
                },
                {
                    "id": "L1",
                    "type": "inductor",
                    "parameters": {"inductance": "1u"},
                    "nodes": ["output", "emitter"],
                },
                {
                    "id": "C1",
                    "type": "capacitor",
    ...
    {
        "name": "crystal_oscillator_pierce",
        "category": "oscillator",
            ...
            "components": [
                {
                    "id": "Y1",
                    "type": "crystal",
                    "parameters": {"frequency": "16M"},
                    "nodes": ["xin", "xout"],
                },
                {
                    "id": "C1",
                    "type": "capacitor",
                    "parameters": {"capacitance": "22p"},
                    "nodes": ["xin", "gnd"],
                },
                {
                    "id": "C2",
    ...
    {
        "name": "comparator_with_hysteresis",
        "category": "digital_interface",
            ...
            "components": [
                {
                    ...
                    "type": "resistor",
                    "parameters": {"resistance": "10k"},
                    "nodes": ["vcc_low", "low_side"],
                },
                {
                    "id": "M1",
                    "type": "mosfet",
                    "parameters": {},
                    "nodes": ["low_side", "high_side", "gnd"],
                },
                {
                    "id": "R2",
                    "type": "resistor",
                    "parameters": {"resistance": "10k"},
                    "nodes": ["vcc_high", "high_side"],
                },
            ],
        },
