...
DESIGN_RULES = [
    ...
    {"topic": "analog_layout_guidelines", "title": "Analog Layout Guidelines",
    ...
    {"topic": "component_selection_criteria", "title": "Component Selection Criteria",
    ...
    {"topic": "opamp_stability", "title": "Op-Amp Stability",
    ...
    {"topic": "feedback_compensation", "title": "Feedback Loop Compensation",
    ...
    {"topic": "current_sensing_techniques", "title": "Current Sensing Techniques",
    ...
    {"topic": "battery_management", "title": "Battery Management Design",
    ...
    {"topic": "motor_driving_basics", "title": "Motor Driving Design",
    ...
    {"topic": "rf_layout_guidelines", "title": "RF Layout Guidelines",
    ...
    {"topic": "crystal_oscillator_layout", "title": "Crystal Oscillator Layout",
    ...
    {"topic": "connector_selection", "title": "Connector Selection Guidelines",
    ...
    {"topic": "thermal_vias", "title": "Thermal Via Design",
    ...
    {"topic": "differential_pair_routing", "title": "Differential Pair Routing",
    ...
    {"topic": "impedance_controlled_routing", "title": "Impedance-Controlled Routing",
    ...
    {"topic": "digital_ic_decoupling", "title": "Digital IC Decoupling Strategy",
    ...
    {"topic": "power_plane_partitioning", "title": "Power Plane Partitioning",
    ...
    {"topic": "ferrite_bead_selection", "title": "Ferrite Bead Selection",
    ...
    {"topic": "esd_protection_strategy", "title": "ESD Protection Strategy",
    ...
    {"topic": "test_point_placement", "title": "Test Point Placement",
    ...
    {"topic": "led_thermal_design", "title": "LED Thermal Design",
    ...
    {"topic": "pcb_stackup_design", "title": "PCB Stackup Design",
